...
@Component({
  selector: 'app-leads-table-simple',
  standalone: true,
    ...
    <div class="p-6">
      ...
      <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
        <div class="flex items-center justify-between mb-4">
          ...
          <button class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-colors">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
          ...
          <div class="flex items-center space-x-3">
            ...
            <button class="p-2 border border-gray-300 dark:border-gray-600 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
...
export class LeadsTableSimpleComponent {
